...
ASExplosiveBarrel::ASExplosiveBarrel()
{
	...
	// Set to physics body to let radial component effect us (eg. when a nearby barrel explodes)
	...
	RadialForceComp->bIgnoreOwningActor = true; // ignore self	( only apply radial force to others )
